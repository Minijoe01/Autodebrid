...
M3U_ZIP = "formule2.zip"         # nom du ZIP généré par ton workflow
...
files = {'file': open(M3U_FILE_IN_ZIP, 'rb')}
data = {
    "apikey": ALLDEBRID_API_KEY,
    "folder": "links",    # dossier AllDebrid
...
if resp_data.get("status") == "success":
    ...
    print(f"Tu peux utiliser ce lien dans Kodi: {resp_data['data']['link']}")
else:
